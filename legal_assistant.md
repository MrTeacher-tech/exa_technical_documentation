...
Next, create your Python file. Import the Exa and Anthropic SDKs and set up your API keys to create client objects for each. You will also need to import pymupdf (for reading the PDF), and os and dotenv (for retrieving API keys).
